...
function Moto(props) {
  ...
  return (
    <div className="vehicule-card moto-card">
      ...
      <KlaxonModal isOpen={openKlaxon} onClose={() => setOpenKlaxon(false)} klaxon={props.klaxon || "Bip ! (Moto)"} />
    </div>
  );
}
export default Moto;
